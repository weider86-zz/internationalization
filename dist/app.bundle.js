!(function (e) {
  function t(t) {
    for (var n, l, i = t[0], o = t[1], a = 0, c = []; a < i.length; a++)
      (l = i[a]),
        Object.prototype.hasOwnProperty.call(r, l) && r[l] && c.push(r[l][0]),
        (r[l] = 0);
  ...
  (l.e = function (e) {
    ...
    if (0 !== n)
      if (n) t.push(n[2]);
        ...
        var i = new Promise(function (t, l) {
          n = r[e] = [t, l];
        });
        t.push((n[2] = i));
        var o,
...
*/ var r =
  ...
  function (e, t, n) {
    var r = n(6),
      l = n(38);
    r(r.G + r.B, { setImmediate: l.set, clearImmediate: l.clear });
  },
  function (e, t, n) {
    var r,
      l,
  ...
  function (e, t, n) {
    for (
      ...
      var v,
        ...
        b = o[y],
        w = b && b.prototype;
      if (w && (w[s] || a(w, s, d), w[f] || a(w, f, y), (u[y] = d), g))
  ...
  function (e, t, n) {
    ...
    (e.exports = n(45)(
      ...
      function () {
        ...
        return !e || n >= e.length
          ? ((this._t = void 0), l(1))
          : l(0, "keys" == t ? n : "values" == t ? e[n] : [n, e[n]]);
      },
      "values"
    )),
      (i.Arguments = i.Array),
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n, m, h, v, y) {
      ...
      var g,
        ...
        T = !1,
        S = e.prototype,
        C = S[f] || S["@@iterator"] || (h && S[h]),
        _ = C || k(h),
        P = h ? (E ? k("entries") : _) : void 0,
        N = ("Array" == t && S.entries) || C;
      if (
        (N &&
          (w = s(N.call(new e()))) !== Object.prototype &&
          w.next &&
          (c(w, x, !0), r || "function" == typeof w[f] || o(w, f, p)),
        E &&
          C &&
          "values" !== C.name &&
          ((T = !0),
  ...
  function (e, t, n) {
    ...
    var r = n(47),
      ...
      i = n(28),
      o = {};
    n(2)(o, n(3)("iterator"), function () {
      return this;
    }),
      (e.exports = function (e, t, n) {
        (e.prototype = r(o, { next: l(1, n) })), i(e, t + " Iterator");
      });
  },
  function (e, t, n) {
    var r = n(9),
  ...
  function (e, t, n) {
    ...
    e.exports = n(4)
      ...
      : function (e, t) {
          l(e);
          for (var n, o = i(t), a = o.length, u = 0; a > u; )
            r.f(e, (n = o[u++]), t[n]);
          return e;
        };
  },
  ...
  function (e, t, n) {
      ...
      return Hr || null == Wr || Wr !== sn(n)
        ...
        : ("selectionStart" in (n = Wr) && mn(n)
          ...
          Br && Ar(Br, n)
            ? null
            : ((Br = n),
              ((e = Bn.getPooled(Vr.select, Qr, e, t)).type = "select"),
              (e.target = Wr),
              Dn(e),
              e));
    }
    ...
    function Bl(e) {
      return null === Ll ? ((Ll = [e]), (Fl = xl(_l, $l))) : Ll.push(e), zl;
    }
    function Hl() {
      if (null !== Fl) {
        var e = Fl;
    ...
    function $l() {
      if (!Dl && null !== Ll) {
        ...
        try {
          ...
          throw (null !== Ll && (Ll = Ll.slice(e + 1)), xl(_l, Hl), t);
        } finally {
          Dl = !1;
        }
      }
    ...
    function Ki(e, t, n, r, l, i) {
      if (
        ...
        (t.updateQueue = null),
        (t.expirationTime = 0),
        (ji.current = null === e || null === e.memoizedState ? yo : go),
        (e = n(r, l)),
        t.expirationTime === Ui)
      ) {
        i = 0;
    ...
    function ro(e, t, n, r) {
      ...
      if (null !== Wi) {
        ...
        if (((i = o.destroy), null !== r && $i(r, o.deps)))
    ...
    function Ko(e, t, n) {
      var r = t.pendingProps,
        l = r.revealOrder,
        i = r.tail;
      if ((Mo(e, t, r.children, n), 0 != (2 & (r = Li.current))))
      ...
      if ((cl(Li, r), 0 == (2 & t.mode))) t.memoizedState = null;
      else
        switch (l) {
          case "forwards":
    ...
    function Go(e, t, n) {
      ...
      switch (t.tag) {
            ...
            if (((e = Oi(_i.current)), _o(t))) {
              ...
              switch (
                ...
                case "select":
                  ...
                  break;
                case "textarea":
                  Me(e, r), (c = Oe(e, r)), Kt("invalid", e), un(n, "onChange");
                  break;
                default:
                  c = r;
              }
              ...
              : ((n = null !== r),
                ...
                n &&
                  ...
                  0 != (1 & Li.current)
                    ? _a === wa && (_a = ka)
                    : ((_a !== wa && _a !== ka) || (_a = xa),
                      0 !== za && null !== Ta && (Iu(Ta, Ca), Ru(Ta, za)))),
                (n || r) && (t.effectTag |= 4),
                null)
          );
        case 4:
        ...
        case 17:
          return hl(t.type) && vl(), null;
        case 19:
          if ((ul(Li), null === (r = t.memoizedState))) return null;
                ...
                if (null !== (e = Fi(a))) {
                  for (
                    ...
                    (a = n),
                      ...
                      (r = r.sibling);
                  return cl(Li, (1 & Li.current) | 2), t.child;
                }
                a = a.sibling;
              }
          } else {
    ...
    function qa(e, t) {
      if (50 < Qa) throw ((Qa = 0), (Ba = null), Error(o(185)));
      if (null !== (e = Ya(e, t))) {
        var n = Ul();
        1073741823 === t
          ? 0 != (8 & Ea) && 0 == (48 & Ea)
    ...
    function Ya(e, t) {
      ...
      return (
        null !== l && (Ta === l && (ou(t), _a === xa && Iu(l, Ca)), Ru(l, t)), l
      );
    }
    function Ga(e) {
    ...
    function Ja(e, t) {
      if (((Ha = 0), t)) return Lu(e, (t = $a())), Xa(e), null;
      var n = Ga(e);
      if (0 !== n) {
        ...
        if ((hu(), (e === Ta && n === Ca) || nu(e, n), null !== Sa)) {
          ...
          if ((Zl(), (Ea = r), (ga.current = l), 1 === _a))
            throw ((t = Pa), nu(e, n), Iu(e, n), Xa(e), t);
          if (null === Sa)
            switch (
    ...
    function Za(e) {
      ...
      if ((hu(), (e === Ta && t === Ca) || nu(e, t), null !== Sa)) {
        ...
        if ((Zl(), (Ea = n), (ga.current = r), 1 === _a))
          throw ((n = Pa), nu(e, t), Iu(e, t), Xa(e), n);
      ...
      if (
        ...
        do {
          try {
            for (w = e; null !== La; ) {
              var E = La.effectTag;
              if ((36 & E && ia(w, La.alternate, La), 128 & E)) {
                k = void 0;
                var T = La.ref;
                if (null !== T) {
                  var S = La.stateNode;
    ...
    function bu(e, t, n) {
      ...
      null !== r && r.delete(t),
        Ta === e && Ca === n
          ? _a === xa || (_a === ka && 1073741823 === Na && Al() - Ra < 500)
            ? nu(e, Ca)
            : (Ia = !0)
          : zu(e, n) &&
      ...
      switch (((t.expirationTime = 0), t.tag)) {
        ...
        case 4:
          return (
            Mi(t, t.stateNode.containerInfo),
            (r = t.pendingProps),
            null === e ? (t.child = Ti(t, null, r, n)) : Mo(e, t, r, n),
            t.child
          );
        case 11:
          return (
            (r = t.type),
            (l = t.pendingProps),
            zo(e, t, r, (l = t.elementType === r ? l : ql(r, l)), n)
          );
        case 7:
      ...
      (t.unstable_scheduleCallback = function (e, n, o) {
        ...
        return (
          ...
          u > a
            ? ((e.sortIndex = u),
              S(O, e),
              null === C(N) && e === C(O) && (F ? i() : (F = !0), l(j, u - a)))
            : ((e.sortIndex = o), S(N, e), L || R || ((L = !0), r(A))),
          e
        );
      }),
  ...
  function (e, t, n) {
    ...
    var r = n(0),
      ...
      i = n(30),
      o = n.n(i);
    const a = Object(r.lazy)(async () => ({
        default: (await n.e(1).then(n.bind(null, 64))).Warning,
      })),
      u = () => {
        ...
        return l.a.createElement(
          ...
          l.a.createElement("h2", null, "Count: ", e),
          l.a.createElement("button", { onClick: () => t(e + 1) }, "+"),
          l.a.createElement("button", { onClick: () => t(e - 1) }, "-"),
          e > 10 &&
            l.a.createElement(
              r.Suspense,
              { fallback: () => l.a.createElement("p", null, "Loading...") },
    ...
    class c extends l.a.Component {
      ...
      render() {
        ...
        return e ? l.a.createElement("div", null, "Something went wrong!") : t;
      }
    }
    n(59);
    o.a.render(
      l.a.createElement(
        l.a.StrictMode,
        null,
        l.a.createElement(c, null, l.a.createElement(u, null))
      ),
